      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-100 rounded-lg shadow p-4">
          ...
          <p className="text-sm text-gray-600 mt-2">
            ...
            with GitHub Actions. Tested with Selenium
          </p>
        </div>
        ...
        <div className="bg-gray-100 rounded-lg shadow p-4">
          ...
          <p className="text-sm text-gray-600 mt-2">
            ...
            CSS, and JavaScript, using PostgreSQL with Sequelize. Developed by a
            team of 14, divided into Backend, Frontend, and
            Documenter/Architects.
          </p>
        </div>
        ...
        <div className="bg-gray-100 rounded-lg shadow p-4">
          <Image
            src="/fotos/carsim.png" // Ruta de la imagen dentro de la carpeta 'public'
            alt="Hotel Platform"
            width={640}
            height={160}
            className="rounded mb-4 cursor-pointer"
            onClick={() => handleImageClick("/fotos/carsim.png")} // Acción al hacer clic
          />
          <h3 className="text-lg font-semibold text-gray-700">
            Vehicle Simulator
          </h3>
          <p className="text-sm text-gray-600 mt-2">
            Built with Java on a Linux environment Develop of a scale a vehicle
            traffic simulation application with an interactive graphical
            interface, allowing the creation of road networks using graphs. Each
            node represents an intersection with a configurable vehicle
            generation rate, and the edges are two-way roads with customizable
            distances. I implemented Dijkstra algorithm to calculate the
            shortest route, ensuring that vehicles travel at 10 km/s and
            managing their traffic with occupancy rules and waiting times at the
            nodes. The simulation displays in real time the position of the
            vehicles, the elapsed time, the number of active vehicles and the
            average speed, providing a dynamic representation of the traffic.
          </p>
        </div>

        <div className="bg-gray-100 rounded-lg shadow p-4">
          <Image
            src="/fotos/mmu.png" // Ruta de la imagen dentro de la carpeta 'public'
            alt="Hotel Platform"
            width={640}
            height={160}
            className="rounded mb-4 cursor-pointer"
            onClick={() => handleImageClick("/fotos/mmu.png")} // Acción al hacer clic
          />
          <h3 className="text-lg font-semibold text-gray-700">MMU Simulator</h3>
          <p className="text-sm text-gray-600 mt-2">

            Development of a memory management simulation in an operating system
            environment, implementing paging with real and virtual memory. The
            simulation allows running processes that allocate, use and free
            memory, managed by an MMU unit with a dynamic page map. Page
            replacement algorithms (FIFO, SC, MRU, RND) were integrated and
            compared in real time against the optimal algorithm (OPT), showing
            key metrics such as page faults, thrashing time, internal
            fragmentation and RAM/V-RAM usage. The graphical interface allows to
            visualize the memory status, active processes and control the
            simulation with pause and resume options.
          </p>
        </div>
        ...
        <div className="bg-gray-100 rounded-lg shadow p-4">
          ...
          <p className="text-sm text-gray-600 mt-2">
            Developed with C++ and NASM. CharParty is a turn-based game that
            consists of buying stars by moving across a map with a total of 50
            squares. a map with a total of 50 squares, of which the first 25 are
            for sequential advancement, and the rest can be 25 are sequential,
            and the rest can be accessed by means of special squares (5, 10,
            15). special squares (5, 10, 15). The boxes have an associated color
            and can contain coins, stars or contain coins, stars or candies,
            which provide abilities to the player. The winner is the person who
            gets the most coins, stars or candies. The winner is the person who
            gets the most stars at the end of the game. of the game.
          </p>
        </div>
